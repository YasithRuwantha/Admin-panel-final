...
<div class="d-flex">
    ...
    <div class="container-fluid mt-4 px-4" style="margin-left:220px;">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h2 class="mb-0">List Expenses</h2>
            <a href="<?php echo site_url('expense/add'); ?>" class="btn btn-primary" style="min-width:150px; font-weight:500; font-size:1.1rem;">+ Add Expense</a>
        </div>
