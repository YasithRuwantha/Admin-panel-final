...
<div class="d-flex">
    ...
    <div class="container-fluid mt-4 px-4 main-content">
        ...
        <div class="alert alert-info d-flex align-items-center justify-content-between py-2 mb-2" role="alert">
            <span><i class="bi bi-funnel-fill me-2"></i>Showing quotations for project: <strong><?php echo htmlspecialchars($exact_project_code); ?></strong></span>
            <a href="<?php echo site_url('quote/list'); ?>" class="btn btn-sm btn-outline-secondary ms-3">× Clear filter</a>
        </div>
        <?php endif; ?>
        <style>
        @media (max-width: 768px) {
